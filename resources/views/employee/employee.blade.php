                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td style="text-align: center;width:20%;"><a href="{{url('edit_employee/'.$employees['id'])}}" class="btn btn-success btn-sm" role="button" title="Edit"><img src="{{asset('storage/pencil-fill.svg')}}" alt="Edit"></a>
                      ...
                      <a href="{{url('delete/'.$employees['id'])}}" onclick="return confirm('Are you sure you want to delete this?')" class="btn btn-danger btn-sm" role="button" title="Delete"><img src="{{asset('storage/trash-fill.svg')}}" alt="Delete"></a></td>
                  </tr>
                  @endforeach
                </tbody>
              </table>
